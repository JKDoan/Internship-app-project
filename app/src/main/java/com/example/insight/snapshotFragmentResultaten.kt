...
class ResultatenFragment : Fragment(R.layout.snapshot_fragment_resultaten){
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val disturbanceResultsButton: ImageButton =
            requireView().findViewById(R.id.disturbanceResultsButton)
        ...
        val disturbanceTextResults: TextView = requireView().findViewById(R.id.disturbanceTextResults)
        ...
        snapshotResultsButton.setOnClickListener {
            ...
            disturbanceResultsButton
                .setImageResource(R.drawable.logo_disturbance_grey)
            disturbanceResultsButton.background = null
            disturbanceTextResults.visibility = View.INVISIBLE


            replaceFragmentInFragment(resultatenFragmentSnapshot())
        }
        ...
        gaugeResultsButton.setOnClickListener {
            ...
            replaceFragmentInFragment(resultatenFragmentGauge())
        }
        ...
        timingResultsButton.setOnClickListener {
            ...
            replaceFragmentInFragment(resultatenFragmentTiming())
        }
        ...
        disturbanceResultsButton.setOnClickListener {
            ...
            replaceFragmentInFragment(resultatenFragmentDisturbance())
        }
    }
